...
typedef struct _SERVER_INFORMATION {
    ...
    // GenStream patch: nếu != 0, suy ra RTSP/video/control/audio port từ base port này
    // (relay offset-forwarding) thay vì dùng port chuẩn 48010/47998/47999/48000.
    // RTSP=base+21, Video=base+9, Control=base+10, Audio=base+11 (offset so với 47989).
    unsigned short serverPortBase;
