...
public class ComputerDetails {
    ...
    // GenStream: nếu true, suy port stream (RTSP/video/control/audio) từ base = activeAddress.port khi launch.
    public boolean derivePortsFromBase;
    ...
    public void update(ComputerDetails details) {
        ...
        // GenStream: chỉ set true, không để poll (newDetails=false) xoá cờ đã đánh dấu.
        if (details.derivePortsFromBase) {
            this.derivePortsFromBase = true;
        }
