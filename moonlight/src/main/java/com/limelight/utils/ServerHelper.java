...
public class ServerHelper {
    ...
    public static Intent createStartIntent(Activity parent, NvApp app, ComputerDetails computer,
        ...
        // GenStream: host qua relay offset-forwarding → để moonlight-common-c suy port stream từ base.
        if (computer.derivePortsFromBase && computer.activeAddress != null) {
            intent.putExtra(Game.EXTRA_SERVER_PORT_BASE, computer.activeAddress.port);
        }
        try {
